...
const messages = {
  zh: {
    ...
    "sidebar.add_folder": "新建目录",
    "sidebar.add_folder.placeholder": "输入目录名称",
    "sidebar.add_folder.button": "新建目录",
    "sidebar.add_folder.success": "目录创建成功",
    "sidebar.add_folder.fail": "目录创建失败，请稍后重试",
    "sidebar.add_folder.required": "目录名称不能为空",
    "sidebar.feeds": "订阅源",
    ...
    "context.folder.delete": "删除目录",
    "context.folder.delete.confirm": "确认删除目录「{name}」?",
    "context.folder.delete.mode": "请选择删除方式。",
    "context.folder.delete.keep_feeds": "仅删除目录并移到未分组",
    "context.folder.delete.delete_feeds": "删除目录及其所有订阅",
  ...
  en: {
    ...
    "sidebar.add_folder.placeholder": "Enter folder name",
    "sidebar.add_folder.button": "Create folder",
    "sidebar.add_folder.success": "Folder created",
    "sidebar.add_folder.fail": "Failed to create folder. Please try again.",
    "sidebar.add_folder.required": "Folder name is required",
    "sidebar.feeds": "Feeds",
    ...
    "context.folder.delete": "Delete folder",
    "context.folder.delete.confirm": "Delete folder “{name}”?",
    "context.folder.delete.mode": "Choose how to handle feeds in this folder.",
    "context.folder.delete.keep_feeds":
      "Delete folder and move feeds to Ungrouped",
    "context.folder.delete.delete_feeds": "Delete folder and all feeds",
